...
Public Class CryCotizacionDet
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CryReportes.CryCotizacionDet.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCryCotizacionDet
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CryCotizacionDet = New CryCotizacionDet()
        rpt.Site = Me.Site
        Return rpt
    End Function
